...
class JANUS():
    ...
    def __init__(self, work_dir: str, fitness_function: Callable,
        ...
        idx, __ = normalize_and_sum(np.array(init_fitness), task='SAS-1oyt')
    ...
    def run(self):
        ...
        for gen_ in range(self.generations):
            ...
            idx_temp, norm_vals = normalize_and_sum(np.array(self.fitness), task='SAS-1oyt')
            ...
            if gen_ == 0:
                ...
                if self.use_NN_classifier == True:
                    ...
                    __, norm_vals = normalize_and_sum(np.array(fit_val), task='SAS-1oyt')
            ...
            idx_sort, norm_vals = normalize_and_sum(np.array(self.fitness), task='SAS-1oyt')
            ### ---- NAT: END NORM ----
            ...
            idx_sort, norm_vals = normalize_and_sum(np.array(self.fitness_loc), task='SAS-1oyt')
            ### ---- NAT: END MULTIOPT ----
            ...
            idx_sort, __ = normalize_and_sum(np.array(self.fitness), task='SAS-1oyt')
            ...
            if gen_ == self.generations - 1:
                ...
                idx_sort, scalarizer_vals = normalize_and_sum(np.array(all_fit), task='SAS-1oyt')
