...
# %%
def randomize_and_sort(fitness_list):
    """
    Parameters
    ----------
    scalarizer: Scalarizer() object
    ...
    #     randomizer_vals.append(gauss(0,1))
    randomizer_vals = np.random.normal(loc=0, scale=1.0, size=(len(fitness_list)))
    randomizer_idx = np.argsort(randomizer_vals)

    return randomizer_idx, randomizer_vals
